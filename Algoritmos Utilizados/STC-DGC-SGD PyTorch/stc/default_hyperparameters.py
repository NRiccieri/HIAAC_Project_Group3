...
hp_net_dict = {
  ...
  'lstm': 
          {'type' : 'CNN', 'lr' : 0.1, 'momentum' : 0.9, 'batch_size' : 32, 'weight_decay' : 0.0, 'optimizer' : 'SGD',
          'lr_decay' : ['LambdaLR', {'lr_lambda' : lambda epoch: 1.0}], 'iterations' : 8000},
  ...
  'resnet50': 
      {'type' : 'CNN', 'lr' : 0.001, 'momentum' : 0.9, 'batch_size' : 32, 'weight_decay' : 5e-4,
          'lr_decay' : ['LambdaLR', {'lr_lambda' : lambda epoch: 0.99**epoch}], 'iterations' : 36000}
}
...
def get_hp_compression(compression):
  ...
  if c ==  "fedavg" : 
    return  {"compression_up" : ["none", {}], "compression_down" : ["none", {}],
               "accumulation_up" : False, "accumulation_down" : False,  "aggregation" :"weighted_mean", "local_iterations" : 100}
